---
title: "Thesis Plots (3/17)- for Committee Meeting"
...
p1 <- ggplot(meanthesis, aes(x = `TSS (mg/L)`, y = `kd (m-1)`)) +
  ...
  labs(title = "Regression: kd (m-1) vs TSS (mg/L)", x = "TSS (mg⁻ᴸ)", y = "kd (m⁻¹)") +
...
p3 <- ggplot(meanthesis, aes(x = `CHLa (ug/L)`, y = `Residual kd after TSS`)) +
  ...
  geom_smooth(method = "lm", color = "black", se = FALSE) +  # Black regression line
  labs(title = "Residual kd vs CHLa", x = "CHLa (µg⁻ᴸ)", y = "Residual kd after TSS (m⁻¹)") +
...
p1 <- ggplot(meanthesis, aes(x = `TSS (mg/L)`, y = `kd (m-1)`)) +
  geom_point(color = "gray70") +  # Use a darker gray for points
  geom_smooth(method = "lm", color = "black", se = FALSE) +  # Black regression line
  labs(title = "Regression: kd vs TSS", x = "TSS (mg⁻ᴸ)", y = "kd (m⁻¹)") +
  geom_text(x = max(meanthesis$`TSS (mg/L)`), y = max(meanthesis$`kd (m-1)`), 
            label = paste(reg_stats_p1$eq, "\n", reg_stats_p1$rsq, "\n", reg_stats_p1$pval, "\n", reg_stats_p1$se), 
            hjust = 1, vjust = 2, size = 2, color = "black") +  # Text color black
  theme_minimal() +
...
ggplot(annadata) +
  ...
  labs(title = "TSS Depths Over Time", x = "Date", y = "TSS (mg⁻ᴸ)") +
...
ggplot(annadata) +
  ...
  labs(title = "CHLa Depths Over Time", x = "Date", y = "CHLa (µg⁻ᴸ)") +
...
p1 <- ggplot(annadata, aes(x = Photic_TSS, y = kd)) +
  geom_point(color = "gray70") +  # Use a darker gray for points
  geom_smooth(method = "lm", color = "black", se = FALSE) +  # Black regression line
  labs(title = "Lake Anna: Photic Zone TSS vs kd", x = "TSS (mg⁻ᴸ)", y = "kd (m⁻¹)") +
...
p3 <- ggplot(annadata, aes(x = Photic_CHLa, y = kd)) +
  geom_point(color = "gray70") +  # Use an even lighter gray for points
  geom_smooth(method = "lm", color = "black", se = FALSE) +  # Black regression line
  labs(title = "Lake Anna: Photic Zone CHLa vs kd", x = "CHLa (µg⁻ᴸ)", y = "kd (m⁻¹)") +
...
p <- ggplot(pocdata, aes(x = TSS, y = POC)) +
  geom_point(color = "gray70") +  # Use a darker gray for points
  geom_smooth(method = "lm", color = "black", se = FALSE) +  # Black regression line
  labs(title = "All Station POC vs TSS", x = "TSS (mg⁻ᴸ)", y = "POC (mg C⁻ᴸ)" ) +
  theme_minimal() +
  theme(
    plot.title = element_text(size = 12, color = "black"),  # Title size and color
    axis.title.x = element_text(size = 10, color = "black"),  # X-axis title size and color
...
# Create the bar plot of OrganicFraction_TSS by Site
bar_plot <- ggplot(pocdata, aes(x = Site, y = OrganicFraction_TSS, fill = Site)) +
  geom_bar(stat = "identity", position = "dodge") +  # Use stat = "identity" to use the actual values of OrganicFraction_TSS
  labs(title = "Organic Fraction to TSS Ratio by Site", 
       x = "Site", 
       y = "Organic Fraction to TSS Ratio") +
  theme_minimal() +
  theme(
    ...
    legend.position = "none"  # Remove the legend since it's not necessary here
  )
