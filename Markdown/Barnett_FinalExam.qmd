...
ggplot(site_summary_long, aes(x = Site, y = Proportion, fill = Sex)) +
  ...
  theme_minimal() +
  labs(title = "Sex Ratios by Site", y = "Proportion", x = "Site", caption = "Figure 1") +
...
kable(table_data,col.names = c("Site", "Present Suitability", "Present MF Estimate", "Glacial Suitability", "Glacial MF Estimate"), caption = "Comparison of Present and Glacial Suitability and Estimated Male-Female Ratios Across Sites") |>
    kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                  full_width = FALSE, 
                  position = "center")
