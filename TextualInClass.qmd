...
```{r}
str_view( envs101, "^[A-Z]{4} .+ [0-9] Hours.$") #the .+ symbol is a filler for a bunch of stuff between the search at the beginning of lines and the end of lines. It basically is a stand in for 1 or more "things" inside of the searches
